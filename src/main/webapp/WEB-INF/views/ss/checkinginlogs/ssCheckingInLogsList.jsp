...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="checkinginlogs:ssCheckingInLogs:edit">
			<%--<li><a href="${ctx}/checkinginlogs/ssCheckingInLogs/form">考勤记录添加</a></li>--%>
		</shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="ssCheckingInLogs" action="${ctx}/checkinginlogs/ssCheckingInLogs/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns"><input id="btnSubmit" class="btn btn-primary" type="submit" value="查询"/></li>
				...
				<li><input id="btnUp" class="btn btn-primary" type="button" value="更新考勤"/></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>更新时间</th>
				<th>备注</th>
				<shiro:hasPermission name="checkinginlogs:ssCheckingInLogs:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="ssCheckingInLogs">
			<tr>
				...
				<shiro:hasPermission name="checkinginlogs:ssCheckingInLogs:edit"><td>
    				<a href="${ctx}/checkinginlogs/ssCheckingInLogs/form?recordid=${ssCheckingInLogs.recordid}">修改</a>
					<a href="${ctx}/checkinginlogs/ssCheckingInLogs/delete?recordid=${ssCheckingInLogs.recordid}" onclick="return confirmx('确认要删除该考勤记录吗？', this.href)">删除</a>
