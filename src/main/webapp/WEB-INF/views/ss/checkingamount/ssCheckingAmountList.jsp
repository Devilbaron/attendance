    ...
    <ul class="ul-form">
        <li><label>日期选择：</label>
            <input name="beginCreateDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
                   value="<fmt:formatDate value="${ssCheckingAmount.beginCreateDate}" pattern="yyyy-MM-dd"/>"
                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/><input name="endCreateDate"
                                                                                            type="text"
                                                                                            readonly="readonly"
                                                                                            maxlength="20"
                                                                                            class="input-medium Wdate"
                                                                                            value="<fmt:formatDate value="${ssCheckingAmount.endCreateDate}" pattern="yyyy-MM-dd"/>"
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="ssCheckingAmount">
        <tr>
            ...
            <shiro:hasPermission name="checkingamount:ssCheckingAmount:edit">
                <td>
                    <a href="${ctx}/checkingamount/ssCheckingAmount/form?id=${ssCheckingAmount.id}">修改</a>
